 ...
 * class EnvironmentManager : a singleton manage all collision avoidance agents in a simulation
 */
public class EnvironmentManager 
{
	...
	public static final EnvironmentManager init(double timeStep,
												...
												double[] velocity)
	{
		instance = new EnvironmentManager(timeStep, neighborDistance, maxNeighbors, timeHorizon, radius, maxSpeed, velocity);
