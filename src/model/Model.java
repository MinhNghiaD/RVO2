...
public class Model extends SimState {
	...
	private void addObstacles(Double2D position, int taille, int type) {
		...
		// TODO : setup senario in to EnvironmentManager
	// /**
	//  * Initialize the agent according to the scenario Case 0 : The agent moves in a
	//  * circular orbit Case 1 : Two groups of opposite agents passing through each
	//  * other Case 2 : Fixed obstacles in the middle of the yard Case 3 : Crossroads
